...
public class Bispo : Pecas
{
    ...
    public Bispo(string cor, int linha, int coluna) : base(cor, linha, coluna)
    {
        ...
        try
        {
            string path = Path.Combine($@"{disk}:\Users\", Environment.UserName, "Xadrez", "bin", "Debug", "imagens", $"bispo_{cor}.png"); // Se estiver dando erro, edite o valor da variável 'disk' para "D"
