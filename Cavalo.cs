...
public class Cavalo : Pecas
{
    public Cavalo(string cor, int linha, int coluna) : base(cor, linha, coluna)
    {
        ...
        try
        {
            string path = Path.Combine($@"{disk}:\Users\", Environment.UserName, "Xadrez", "bin", "Debug", "imagens", $"cavalo_{cor}.png"); // Se estiver dando erro, edite o valor da variável 'disk' para "D"
